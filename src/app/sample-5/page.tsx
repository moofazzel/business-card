  ...
  return (
    <div className="relative min-h-screen bg-slate-900 text-white font-sans overflow-hidden">
      ...
      <main className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(56,189,248,0.15)_0%,_rgba(14,165,233,0.1)_60%)] reveal-left"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-sky-950 to-slate-900 opacity-90 morph-gradient reveal-left delay-100"></div>
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          {mounted && (
            <>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-sky-500 to-cyan-400 transform rotateY(0deg) translateZ(20px) opacity-50"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-sky-600 to-cyan-500 transform rotateY(180deg) translateZ(20px) opacity-50"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-sky-700 to-cyan-600 transform rotateX(90deg) translateZ(20px) opacity-50"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-sky-800 to-cyan-700 transform rotateX(-90deg) translateZ(20px) opacity-50"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-sky-900 to-cyan-800 transform rotateY(90deg) translateZ(20px) opacity-50"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-sky-400 to-cyan-300 transform rotateY(-90deg) translateZ(20px) opacity-50"></div>
              </div>
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 30% 30%, rgba(56,189,248,0.6), rgba(14,165,233,0.3))",
                  boxShadow:
                    "0 0 40px rgba(14,165,233,0.3), inset 0 0 30px rgba(14,165,233,0.3)",
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(45deg, transparent, transparent 40%, rgba(56,189,248,0.4)) border-box",
                  WebkitMask:
              ...
              <div
                ...
                style={{
                  ...
                  borderBottom: "80px solid rgba(56,189,248,0.4)",
          ...
          <div className="flex flex-col items-center md:flex-row h-[calc(100%-100px)] justify-center w-full">
            ...
            <div className="relative md:w-1/2 h-full md:h-[600px] flex items-center justify-center z-10">
              ...
              <div className="relative z-20 w-64 md:w-80 float-in delay-700">
                {/* Glass Card */}
                <div className="bg-gradient-to-br from-slate-800/40 to-sky-900/30 backdrop-blur-md p-6 rounded-lg border border-sky-500/10 shadow-xl overflow-hidden relative morph-gradient">
                  {/* Glowing accent */}
                  <div className="absolute -top-10 -right-10 w-20 h-20 bg-sky-500/30 rounded-full blur-xl morph-gradient"></div>
                  <div className="absolute -bottom-10 -left-10 w-20 h-20 bg-cyan-500/30 rounded-full blur-xl morph-gradient delay-100"></div>

                  {/* Content */}
                  <h3 className="text-xl font-semibold mb-3 bg-gradient-to-r from-sky-200 to-cyan-200 bg-clip-text text-transparent reveal-right delay-800">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center w-full bg-gradient-to-r from-sky-500/80 to-cyan-500/80 hover:from-sky-500/90 hover:to-cyan-500/90 py-3 px-4 rounded-md text-white font-medium shadow-lg transition-all duration-300 group reveal-bottom delay-800"
                  >
                ...
                <div className="flex justify-between mt-4 items-center">
                  <div className="bg-slate-800/50 backdrop-blur-sm px-3 py-1 rounded-full border border-sky-500/30 text-xs flex items-center reveal-right delay-800">
                    <svg
                  ...
                  <div className="bg-slate-800/50 backdrop-blur-sm px-3 py-1 rounded-full border border-cyan-500/30 text-xs flex items-center reveal-right delay-800">
                    <svg
                      className="w-3 h-3 mr-1"
                      fill="currentColor"
                      viewBox="0 0 20 20"
      ...
      >
        ...
        {/* Modal Content */}
        <div
          className={`relative z-10 w-full max-w-md bg-gradient-to-br from-slate-800/90 to-sky-900/90 backdrop-blur-lg rounded-xl border border-sky-500/10 shadow-2xl transition-all duration-500 ${
            isModalOpen
        ...
        >
          ...
          <form onSubmit={(e) => e.preventDefault()} className="p-6 space-y-4">
            <div className="space-y-4">
              <div className="transform transition-all duration-300 delay-100">
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full px-4 py-2 bg-slate-800/50 border border-sky-500/20 rounded-md text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-sky-500/60"
              ...
              <div className="transform transition-all duration-300 delay-300">
                ...
                <textarea
                  id="message"
                  rows={4}
                  className="w-full px-4 py-2 bg-slate-800/50 border border-sky-500/20 rounded-md text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-sky-500/60 resize-none"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600 py-3 px-4 rounded-md text-white font-medium shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
            >
              Send Message
            </button>
          </form>
